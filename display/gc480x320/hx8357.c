...
void hx8357Rotate(uint8_t rotate)
{
    CLR(DISP_CS);
...
void hx8357Shift(int16_t value)
{
    CLR(DISP_CS);
...
void hx8357SetWindow(int16_t x, int16_t y, int16_t w, int16_t h)
{
    int16_t x1 = x + w - 1;
    int16_t y1 = y + h - 1;
